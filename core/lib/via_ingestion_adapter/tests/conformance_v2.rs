...
use via_btc_client::{ingestion_engine_v2::ViaProtocolEngineV2, test_message_encoder::TestMessageEncoder};
...
impl TestHarness for PgHarness {
    type Engine = ViaProtocolEngineV2;
    ...
    async fn engine(&self) -> Self::Engine {
        ViaProtocolEngineV2::new(Network::Regtest)
    }
