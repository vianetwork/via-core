/*
1- create migration for new table -> Done
2- finalizing the via_data_availability_dal (add the new method and update the existing one to use the new table) -> Done
