...
use via_state_keeper::{seal_criteria::ConditionalSealer, OutputHandler, StateKeeperIO};
...
impl Resource for BatchExecutorResource {
    fn name() -> String {
        "via_state_keeper/batch_executor".into()
    }
}
...
impl Resource for OutputHandlerResource {
    fn name() -> String {
        "via_state_keeper/output_handler".into()
    }
}
...
impl Resource for ConditionalSealerResource {
    fn name() -> String {
        "via_state_keeper/conditional_sealer".into()
    }
}
