...
use via_state_keeper::{MempoolFetcher, MempoolGuard, MempoolIO, SequencerSealer};
...
use crate::{
    implementations::resources::{
        ...
        via_state_keeper::{ConditionalSealerResource, StateKeeperIOResource},
    },
...
impl Task for MempoolFetcher {
    fn id(&self) -> TaskId {
        "via_state_keeper/mempool_fetcher".into()
    }
