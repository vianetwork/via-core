...
use via_verification::version_28::{
...
async fn main() -> anyhow::Result<()> {
    ...
    let path = "via_verifier/lib/via_verification/examples/data/data_batch_9_0_28_0.bin";

    // let blob_id =
    //     "0000000000819f9337a25262c069eddd0d5eef932523de2e45a5a6c890e5b06a1c0464859bad74d6";

    // _fetch_proof_from_da(path, blob_id).await?;
