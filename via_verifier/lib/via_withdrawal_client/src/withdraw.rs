...
pub fn parse_l2_withdrawal_message(
    ...
    let log_address = BitcoinAddress::from_str(&log_address_str)
    ...
    if log_address != address {
        anyhow::bail!(
            "Mismatch l1 address, log {:?}, pubdata {:?}",
            log_address,
            address
        )
    }
    ...
    Ok(WithdrawalRequest {
        ...
        l2_tx_log_index: l2_tx_log_index.as_u64() as i64,
    })
}
...
mod tests {
    ...
    use zksync_types::{H160, H256, U64};
