...
| Stage watermarks for stalls | `report_watermarks` | [zkSync `house_keeper/src/blocks_state_reporter.rs` L34-81](https://github.com/matter-labs/zksync-era/blob/ff5f519b11cff863edcfa0f75af10fea113806b0/core/node/house_keeper/src/blocks_state_reporter.rs#L34-L81) | Adopted | Watermarks read from the database survive restarts and follow reorgs. A clearable current-batch gauge is rejected, because every early return must clear it. |
